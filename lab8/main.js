function createUpvotesElement(record){
    ...
    function createFactListElement(record){
    let element = document.createElement('div');
    element.classList.add('facts-list-item');
    ...
    factsList.append(createFactListElement(records[i]));
    }
    }
    ...
    function renderPaginationElement(info){
        let btn;
        let paginationContainer=document.querySelector('_pagination');
